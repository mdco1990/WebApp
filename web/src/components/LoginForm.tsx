...
const LoginForm: React.FC<Props> = ({
  ...
  return (
    <Form noValidate validated={validated} onSubmit={(e: React.FormEvent<HTMLFormElement>) => {
      ...
      <button type="submit" className="btn btn-primary w-100 mb-3 d-inline-flex align-items-center justify-content-center" aria-label={t('auth.login', { defaultValue: 'Log in' })} disabled={loading}>

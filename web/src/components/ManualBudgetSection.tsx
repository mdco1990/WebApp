...
export interface ManualBudgetItem { id: string; name: string; amount: number }
export interface ManualBudgetState { bankAmount: number; items: ManualBudgetItem[] }
...
const ManualBudgetSection: React.FC<Props> = ({
  ...
  const remaining = manualBudget.bankAmount + manualBudget.items.reduce((s, i) => s + (i.amount || 0), 0)
  return (
    <div className="row">
